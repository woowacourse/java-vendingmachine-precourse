...
public class StringConstant {
	public static String VENDING_MACHINE_BALANCE_MESSAGE = "자판기가 보유하고 있는 금액을 입력해 주세요.";

	public static String ERROR_PREFIX = "[ERROR] ";
	public static String BALANCE_PRICE_PREFIX = "금액은 ";
	public static String INSERT_MONEY_PREFIX = "투입 금액은 ";
	public static String NOT_NUMBER = "숫자여야 합니다.";
	public static String NOT_POSITIVE = "0보다 커야 합니다.";
	public static String NOT_COIN_VALUE = "10원으로 나누어 떨어져야 합니다.";
	...
	public static String VENDING_MACHINE_PRODUCT_MESSAGE = "상품명과 가격, 수량을 입력해 주세요.";
