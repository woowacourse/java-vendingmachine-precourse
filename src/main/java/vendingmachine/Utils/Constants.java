...
public class Constants {
	...
	public static final String PRODUCT_REGEX = NAME_REGEX + DELIMITER + MONEY_REGEX + DELIMITER + NUMBER_REGEX;

	// 정규식 패턴 상수
	public static final Pattern MONEY_PATTERN = Pattern.compile("^" + MONEY_REGEX + "$");
	public static final Pattern NAME_PATTERN = Pattern.compile("^" + NAME_REGEX + "$");
	public static final Pattern PRODUCTS_PATTERN = Pattern.compile(
		"^(\\[" + PRODUCT_REGEX + "])(" + SEPARATOR + "\\[" + PRODUCT_REGEX + "])*$");
