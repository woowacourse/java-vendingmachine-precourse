...
public class Constants {
	...
	public static final String ERROR_BEVERAGE_EXPENSIVE = ERROR + "보유금액 이하 가격의 제품을 선택해야 한다.";
	public static final String ERROR_USER_POOR = ERROR + "최소 물품금액보다 많은 돈을 투입해야 한다.";
