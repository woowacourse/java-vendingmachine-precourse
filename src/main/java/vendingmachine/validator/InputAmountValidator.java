...
public class InputAmountValidator {
	...
	private final static String ONLY_NUMBER_ERROR_MESSAGE = "[ERROR] 자판기 보유 금액은 숫자여야합니다.";
	private final static int DIVIDE_BY_10 = 10;
	private final static String DIVIDE_BY_10_ERROR_MESSAGE = "[ERROR] 자판기 보유 금액은 10으로 나누어 떨어져야합니다.";
