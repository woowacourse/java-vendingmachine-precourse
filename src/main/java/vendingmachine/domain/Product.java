...
public class Product {
	...
	private static final String ERROR_INVALID_PRICE_AND_QUANTITY = "상품의 가격, 수량 정보가 잘못되었습니다.";
	...
	public static Product fromProductInformation(String productInformation) {
		...
		validateInputProduct(information);
	...
	private static void validateInputProduct(String[] information) {
		if (!ValidateUtils.isDigits(information[1], information[2])) {
			throw new IllegalArgumentException(ERROR_INVALID_PRICE_AND_QUANTITY);
		}
