...
public class Constant {
    ...
    public static final String MACHINE_MONEY_INPUT_IS_NOT_NUMBER_ERROR_STRING = "[ERROR] 금액은 숫자여야 합니다.";
    public static final String MACHINE_MONEY_INPUT_IS_NOT_POSITIVE_NUMBER_ERROR_STRING = "[ERROR] 금액은 양수이어야 합니다.";
