...
public final class ConstantConfig {
	...
	public static final String OUTPUT_CUSTOMER_AMOUNT = "투입 금액: %d" + WON;
	public static final String OUTPUT_CUSTOMER_CHANGE = "잔돈";
	public static final String OUTPUT_CUSTOMER_NUN_OF_CHANGES = "%d" + WON + HYPHEN + "%d" + EA;
	...
	public static final String AMOUNT_IS_NOT_RANGED_EXCEPTION_MESSAGE =
		ERROR + " 금액의 최소 단위는 " + COIN_MIN + WON + " 이상이어야 합니다.";
	...
	public static final String PRODUCT_INPUT_FORMAT_EXCEPTION =
		ERROR + " 상품 입력이 올바르지 않습니다. ex) [상품이름" + COMMA + "가격(" + COIN_MIN + WON + " 이상)" + COMMA + "수량(1" + EA
			+ " 이상)]";
