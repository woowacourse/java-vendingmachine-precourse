...
public class Message {
    ...
    public static final String ERROR_MACHINE_GOODS_INPUT_SQUARE_BRACKETS = "[ERROR] 잘못된 입력입니다. 상품정보는 대괄호로 시작하고 끝나야 합니다. (eg. [상품명,가격,수량])";
    public static final String ERROR_MACHINE_GOODS_INPUT_COMMA = "[ERROR] 잘못된 입력입니다. 상품명, 가격, 수량은 쉼표로 구분되어야 합니다. (eg. [상품명,가격,수량])";
    public static final String ERROR_MACHINE_GOODS = "[ERROR] 잘못된 입력입니다. (eg. [상품명,가격,수량])";
    public static final String ERROR_MACHINE_GOODS_PRICE = "[ERROR] 잘못된 입력입니다. 상품의 가격은 100원 이상이여야 합니다.";
    public static final String ERROR_MACHINE_GOODS_QUANTITY = "[ERROR] 잘못된 입력입니다. 상품의 수량은 0개 이상이여야 합니다.";
