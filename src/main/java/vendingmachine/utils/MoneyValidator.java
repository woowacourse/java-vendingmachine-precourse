...
public class MoneyValidator {
	public static final String ERROR_NOT_INTEGER = "[ERROR] 금액은 숫자로 입력해주세요.";
	public static final String ERROR_NOT_POSITIVE = "[ERROR] 금액은 0원보다 작을 수 없습니다.";
	public static final String ERROR_NOT_MULTIPLE_OF_TEN = "[ERROR] 금액의 최소 단위는 10원입니다.";

	public void validateMoney(String inputValue) {
