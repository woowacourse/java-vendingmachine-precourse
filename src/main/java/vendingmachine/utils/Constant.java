...
public final class Constant {
	...
	public static final String OUTPUT_CUSTOMER_AMOUNT = LINE_SEPARATOR + "투입 금액: %d원" + LINE_SEPARATOR;
	public static final String OUTPUT_CUSTOMER_CHANGE = "잔돈";
	public static final String OUTPUT_CUSTOMER_NUN_OF_CHANGES = "%d원 - %d개" + LINE_SEPARATOR;
