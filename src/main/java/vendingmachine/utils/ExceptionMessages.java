...
public class ExceptionMessages {
    ...
    public static final String EMPTY_INPUT_EXCEPTION = ERROR + "개별 상품 정보를 입력하지 않았습니다.";
    ...
    public static final String EMPTY_NAME_INPUT_EXCEPTION = ERROR + "상품명을 입력하지 않았습니다.";
