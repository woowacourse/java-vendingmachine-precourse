...
public class Message {
	...
	public static final String WRONG_REGEX_MATCH_ERROR = "[ERROR] 올바른 형식으로 입력해주세요.";
	public static final String DUPLICATED_NAME_ITEM_ERROR = "[ERROR] 중복된 상품 이름은 허용하지 않습니다.";
}
