...
public class OutputView {
	...
	public static void showVendingMachineCoinStatus(LinkedHashMap<Integer, Integer> vendingMachineCoinStatus) {
		System.out.println();
		System.out.println(VENDING_MACHINE_HAVING_COIN_STATUS);
		for (Integer coinValueUnit : vendingMachineCoinStatus.keySet()) {
			System.out.println(coinValueUnit + COIN_VALUE_UNIT + HYPHEN + vendingMachineCoinStatus.get(coinValueUnit)
				+ COIN_COUNT_UNIT);
		}
	}
