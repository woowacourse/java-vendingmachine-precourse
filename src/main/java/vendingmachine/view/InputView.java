...
public class InputView {
    ...
    private static final String INPUT_USER_INPUT_AMOUNT_MESSAGE = "투입 금액을 입력해 주세요.";
    ...
    public static void printUserInputAmountMessage() {
        System.out.println(INPUT_USER_INPUT_AMOUNT_MESSAGE);
    }
}
