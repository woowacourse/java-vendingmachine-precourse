...
public class InputView {
  private static final String VENDING_MACHINE_HAVING_MONEY_INPUT_MESSAGE =
      "자판기가 보유하고 있는 금액을 입력해 주세요.";
  private static final String MERCHANDISE_NAME_PRICE_QUANTITY_INPUT_MESSAGE =
      "상품명과 가격, 수량을 입력해 주세요.";
  ...
  public static String inputMerchandiseInfomation() {
    System.out.println();
