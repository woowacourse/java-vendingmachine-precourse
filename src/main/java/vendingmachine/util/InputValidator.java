...
public class InputValidator {
    ...
    private static List<String> validateProductList(String input) {
        ...
        List<String> productList = Arrays.asList(input.split(SEMI_COLON));
    ...
    private static List<String> validateProductDetails(String productDetails) {
        if (productDetails.endsWith(COMMA)) {
            throw new IllegalArgumentException(ERROR_MESSAGE + INVALID_EACH_PRODUCT_INPUT_MESSAGE + RETRY_MESSAGE);
        }

        List<String> productDetailList = Arrays.asList(productDetails.split(COMMA));
        ...
        product.add(validateProductName(productDetailList.get(INDEX_ZERO)));
        product.add(validateProductPrice(productDetailList.get(INDEX_ONE)));
        product.add(validateProductQuantity(productDetailList.get(INDEX_TWO)));
