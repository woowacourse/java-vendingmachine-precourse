...
public final class Constants {
	...
	public static final String INPUT_MESSAGE_INPUT_AMOUNT = "투입 금액을 입력해 주세요.";
	...
	public static final String ERROR_MESSAGE_INPUT_INPUT_AMOUNT = ERROR_MESSAGE + "금액은 양수여야 합니다.";
	...
	public static final int INPUT_AMOUNT_MIN_VALUE = 1;
}
