...
public class VendingMachineController {
	...
	private final VendingMachineInputController vendingMachineInputController;
	...
	public VendingMachineController(final VendingMachineOutput vendingMachineOutput,
			final VendingMachineInputController vendingMachineInputController, final CoinTypeAmountGenerator coinTypeAmountGenerator) {
		this.vendingMachineOutput = vendingMachineOutput;
		this.vendingMachineInputController = vendingMachineInputController;
		this.coinTypeAmountGenerator = coinTypeAmountGenerator;
	}

	private void inputVendingMachineInformation() {
		final int amountMoney = vendingMachineInputController.inputAmountOfMoney();
		...
		ArrayList<Product> products = vendingMachineInputController.inputProductsInformation();
		vendingMachine = new VendingMachine(coinTypesAmount, products);
		final int userInputtedMoney = vendingMachineInputController.inputMoney();
	...
	private void purchaseProduct() {
		while(canPurchaseProduct()) {
			...
			final String selectedProduct = vendingMachineInputController.selectProduct();
