...
public enum ErrorMessage {
	...
	PRODUCT_DUPLICATE_NAME_ERROR_MESSAGE(ERROR_MESSAGE.get() + "상품명은 중복되지 않게 입력해주세요."),
	PRODUCT_ALREADY_REGISTERED_ERROR_MESSAGE(ERROR_MESSAGE.get() + "이미 등록된 상품을 입력하셨습니다."),
