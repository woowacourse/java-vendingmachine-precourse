...
class VendingMachineTest {
    ...
    void 자판기_초기_금액_입력_0보다_적은_경우_오류(int inputMoney) {
        Assertions.assertThatThrownBy(() ->VendingMachine.makeVendingMachineHasMoney(inputMoney)).isInstanceOf(IllegalArgumentException.class); //TODO: 문구는 나중에 생성
    }
    ...
    void 자판기_초기_금액_최소_동전으로_만들수_없음(int inputMoney) {
        Assertions.assertThatThrownBy(() ->VendingMachine.makeVendingMachineHasMoney(inputMoney)).isInstanceOf(IllegalArgumentException.class);
    }
}