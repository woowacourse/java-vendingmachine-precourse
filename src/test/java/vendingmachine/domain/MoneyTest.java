...
public class MoneyTest extends DomainTest {
    ...
    void checkInsertMoneyEnough_false() {
        vendingMachine.createBeverages("[콜라,2000,10]");
        vendingMachine.insertMoney("3000");
        assertThrows(IllegalArgumentException.class, () -> vendingMachine.getMoney().isInsertPriceUnderBeveragePrice(4000));
    }
    ...
    void checkInsertMoneyEnough_true() {
        vendingMachine.createBeverages("[콜라,2000,10]");
        vendingMachine.insertMoney("3000");
        assertDoesNotThrow(() -> vendingMachine.getMoney().isInsertPriceUnderBeveragePrice(2000));
    }
