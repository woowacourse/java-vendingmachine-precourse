...
class BeverageTest extends DomainTest {
    ...
    void delimiterNotSemiColon_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,1500,20],[사이다,1000,20]"));
    }
    ...
    void notStartWithSquareBracket_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("{콜라,1500,20]"));
    }
    ...
    void priceNotNumber_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,a,20]"));
    }
    ...
    void priceUnder100_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,99,20]"));
    }
    ...
    void priceNotDivideBy10_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,101,20]"));
    }
    ...
    void countNotNumber_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,1000,a}"));
    }
    ...
    void countUnder0_false() {
        assertThrows(IllegalArgumentException.class, () ->
                vendingMachine.getBeverages().addBeverage("[콜라,1000,0]"));
    }
    ...
    void createBeverage_true() {
        ...
        beverages.addBeverage("[콜라,1000,1]");
