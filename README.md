...
- [ ] 입력을 받는 기능 
  ...
  - [ ] "금액"을 입력 받는 기능
    ...
    - [ ] 자판기가 보유하고 있는 금액
    - [ ] 사용자가 투입하는 금액
    - [ ] [ERROR] 10원으로 나누어 떨어지는지 검증하는 기능

  - [ ] [상품명, 가격, 수량]을 입력 받는 기능

    - [ ] [ERROR] 가격이 10으로 나누어 떨어지는지 검증하는 기능
    - [ ] [ERROR]올바른 형식([상품명, 가격, 수량])으로 들어오는지 검증하는 기능

  - [ ] 구매할 상품명을 입력받는 기능

    - [ ] [ERROR] 자판기에 있는 물품인지 검증하는 기능 
...
- [ ]  자판기 기능
  - [ ] 상태
    ...
    - [ ] 잔돈 개수 
    - [ ] 상품
  - [ ] 자판기에 있는 처음 금액으로 동전을 무작위로 생성하는 기능
