...
- [x] 자판기가 보유한 동전 정보를 출력하는 기능
- [ ] 자판기에 추가할 `상품명, 가격, 수량`을 입력하는 기능
  - [x] `Console API`
  - [ ] 입력 검증 
...
- [x] 투입 금액을 입력하는 기능
  ...
  - [x] 입력 검증 
    - [x] 양수를 입력해야 한다.
    - [x] 10으로 나누어 떨어져야 한다.
- [x] 현재 남아있는 투입 금액 출력하는 기능
- [x] 구매할 상품명 입력하는 기능
  - [x] `Console API`
  - [x] 입력 검증
    - [x] 없는 상품명을 입력한 경우 예외 처리
- [x] 계산하는 기능
  - [x] 투입 금액에서 구매할 상품 가격을 뺀다.
  - [ ] 음수인 경우, 예외 처리
  - [x] 남은 금액이 입력된 상품들의 최저 가격보다 적거나, 모든 상품이 소진됐는지 확인
    - [x] O : 잔돈 반환
    - [x] X : 구매할 상품명 입력
- [x] 잔돈을 반환하는 기능 
