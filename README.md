...
1. 자판기 보유금 입력 요청을 출력한다.
2. 자판기 보유금을 입력 한다.
- 입력한 자판기 보유금이 ```올바른 입력인지 검증```한다. (하단 자판기 보유금 검증 참조)
...
## ❗❗ 입력 검증 목록
### 자판기 보유금 입력 검증
1. 자판기 보유금이 빈값("")인 경우 예외를 발생한다.
2. 자판기 보유금에 공백이 포함 되는 경우 예외를 발생한다.
3. 자판기 보유금에 음수, 문자, 기호가 있는 경우 예외를 발생한다.
4. 자판기 보유금이 0으로 시작하는 경우 예외를 발생한다.
5. 자판기 보유금이 10으로 나누어 떨어지지 않으면 예외를 발생한다.
